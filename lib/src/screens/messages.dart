...
import 'package:yime2_mock_ui/src/screens/chatscreen.dart';
...
Widget messageList(
    BuildContext context, bool online, var userName, bool hasUnreadMessage) {
  if (online == true) {
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: Column(
                  children: <Widget>[
                    messageList(context, true, "Joy Paul", true)
                  ],
                ),
              );
            }),
